  ...
  return (
    <footer className="border-t border-border bg-card mt-16">
      <div className="container mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-3 gap-8">
        <div>
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="font-display text-sm font-bold text-foreground tracking-widest">VPEASY</span>
          </div>
        ...
        <div>
          ...
          <div className="flex flex-col gap-2 text-sm text-muted-foreground">
            <span>contato@vpeasy.com.br</span>
      ...
      <div className="border-t border-border/30 py-4 text-center text-xs text-muted-foreground">
        © 2026 VPEASY. Todos os direitos reservados.
      </div>
    </footer>
  );
};
